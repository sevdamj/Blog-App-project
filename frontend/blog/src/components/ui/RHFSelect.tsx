...
export default function RHFSelect<TFormValues extends Record<string, unknown>>({
  name,
  label,
  register,
  errors,
  ...
  // گرفتن مقدار فعلی از register
  const currentValue = register(name).value as string;
